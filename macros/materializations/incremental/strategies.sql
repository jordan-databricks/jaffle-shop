...
{% macro create_table_with_identity(relation, identity_start=1) %}
    {%- set identifier_with_identity = relation.identifier ~ '_with_identity' -%}
    ...
    {%- log("Creating identity table " ~ identifier_with_identity ~ " in schema " ~ relation.schema ~ " in database " ~ relation.database, info=True) -%} 
